...
export const JobSchema = z
    .object({
        ...
        job_SalaryMin: z.coerce.number().positive(),
        job_SalaryMax: z.coerce.number().positive(),
    ...
    .refine((data) => data.job_SalaryMin < data.job_SalaryMax, {
        message: "Minimum salary range must be less than maximum.",
        path: ["job_SalaryMin"],
    })
    .refine((data) => data.job_SalaryMax > data.job_SalaryMin, {
        message: "Maximum salary range must be more than minimum.",
        path: ["job_SalaryMax"],
    });
