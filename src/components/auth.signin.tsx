      ...
      <DialogContent className="sm:max-w-[425px] s">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="">
            <div className="grid gap-4 py-4 space-y-5 mb-4">
            ...
            <Button disabled={isPending} className="w-full" type="submit">
              {isPending ? (
                <div className="flex items-center gap-2">
                  <svg
                    aria-hidden="true"
                    className="w-5 h-5 text-white animate-spin  fill-slate-400"
                    viewBox="0 0 100 101"
                    fill="none"
        ...
        <div className="flex gap-x-2 text-sm justify-center text-muted-foreground">
          <div>No Account?</div> <SignUp label="Create One" ghost={true} />
        </div>
      </DialogContent>
    </Dialog>
  );
